	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// A-Z, a-z are only acceptable characters -> State 1
			...
			case 1: 
				...
				//  2: Four acceptable symbols to transition to state 2: "-", "_", "&", "."
			...
			case 2: 
				// State 2 deals with a character after a period, a hyphen, an ampersand, or an underline in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, a hypen, an underscore, or an ampersand must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
