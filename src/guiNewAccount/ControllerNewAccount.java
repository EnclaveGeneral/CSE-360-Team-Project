...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		// Before we proceed, we need to ensure our username is valid 
		// Call up our other packages that checks for a valid username, 
		// If it is invalid, we will simply end the process and return before. 
		...
		if (usernameError.length() > 0) {
			...
			ViewNewAccount.alertUsernamePasswordError.setHeaderText("Username does not meet the requirement(s)");
